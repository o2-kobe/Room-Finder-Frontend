...
export default function ProfilePage() {
  ...
  const activeListings = userListings.filter((l) => l.availability !== 'inactive');
  const inactiveListings = userListings.filter((l) => l.availability === 'inactive');
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary-foreground/80">Property Manager</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
              <p className="text-sm text-primary-foreground/80 mb-1">Active Listings</p>
              <p className="text-2xl">{activeListings.length}</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
              <p className="text-sm text-primary-foreground/80 mb-1">Total Views</p>
