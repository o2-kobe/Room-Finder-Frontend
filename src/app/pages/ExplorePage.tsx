...
export default function ExplorePage() {
  ...
  const filteredListings = mockListings.filter((listing) => {
    ...
    const matchesSearch =
      ...
      listing.location.area.toLowerCase().includes(filters.searchQuery.toLowerCase()) ||
      listing.location.university.toLowerCase().includes(filters.searchQuery.toLowerCase());
